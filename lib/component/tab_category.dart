                ...
                return GestureDetector(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: index == selectedIndex ? Theme.of(context).primaryColor.withOpacity(0.5) : Colors.transparent,
                          spreadRadius: 0,
                          blurRadius: 4,
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        color:
                            index == selectedIndex ? Colors.white : Theme.of(context).primaryColor,
