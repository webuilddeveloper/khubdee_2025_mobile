...
import 'package:flutter_datetime_picker_plus/flutter_datetime_picker_plus.dart'
    as picker;
import 'package:KhubDeeDLT/widget/textbox.dart';
...
import 'package:KhubDeeDLT/pages/profile/policy_identity_verification.dart';
...
class _IdentityVerificationPageState extends State<IdentityVerificationPage> {
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Icon(Icons.add, color: Color(0xFFBC0611)),
              SizedBox(width: 5), // เพิ่มระยะห่างระหว่างไอคอนกับข้อความ
              Text(
                '* เพิ่มหน่วยงาน',
                style: TextStyle(
                  fontSize: 15.0,
  ...
  Widget datePicker({required TextEditingController controller, required String title, required BuildContext context}) {
