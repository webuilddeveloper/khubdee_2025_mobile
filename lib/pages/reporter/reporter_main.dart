import 'dart:convert';
import 'package:KhubDeeDLT/pages/reporter/reporter_list_category.dart';
import 'package:KhubDeeDLT/pages/reporter/reporter_list_category_disaster.dart';
import 'package:KhubDeeDLT/pages/reporter/reporter_map.dart';
import 'package:flutter/material.dart';
import 'package:flutter_secure_storage/flutter_secure_storage.dart';
import 'package:KhubDeeDLT/component/header.dart';
import 'package:KhubDeeDLT/pages/reporter/reporter_history_list.dart';
                  ...
                  for (var i = 0; i < _dataOrganization.length; i++)
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "- ${_dataOrganization[i]['titleLv0']} ${_dataOrganization[i]['titleLv1']} ${_dataOrganization[i]['titleLv2']} ${_dataOrganization[i]['titleLv3']} ${_dataOrganization[i]['titleLv4']}",
