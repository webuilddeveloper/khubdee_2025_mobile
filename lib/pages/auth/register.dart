...
class _RegisterPageState extends State<RegisterPage> {
  ...
  dialogOpenPickerDate() {
    dtpicker.DatePicker.showDatePicker(
      ...
      locale: dtpicker.LocaleType.th, // อย่าลืมเติม dtpicker. ที่นี่ด้วย
    );
  }
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: CheckboxListTile(
            activeColor: const Color(0xFFFF7514),
            title: const Text(
        ...
        Container(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                ...
                backgroundColor: const Color(0xFFFFC324), // Text color
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(10.0),
                  side: const BorderSide(
                    color: Color(0xFFFFC324), // Border color
                  ),
                ),
              ),
              onPressed: () {
    ...
    return (Form(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          // ),
          textFormField(
            txtUsername, // Argument 1: TextEditingController
            '', // Argument 2: modelMatch (empty string or a value to match)
            'ชื่อผู้ใช้งาน', // Argument 3: hintText
            'กรุณากรอกชื่อผู้ใช้งาน', // Argument 4: validator (text to display or a validation message)
            true, // Argument 5: enabled
            false, // Argument 6: isPassword
            false, // Argument 7: isEmail
          ),
